      ...
      <div className='flex flex-col space-y-10'>
        ...
        <div className='space-y-10 flex flex-col items-center '>
            ...
            <div className='flex items-center space-x-5 justify-center'>
                 ...
                 <p className='text-2xl'>emmanuelnyantakyiboahen@gmail.com</p>
                 </div>
        </div>

        <form className='flex w-[90%] flex-col space-y-2  mx-auto'>
            <div className='flex space-x-2'>
                <input placeholder='Name' className='outline-none bg-slate-400/10 rounded-sm border-b px-6 py-4 border-[#242424] text-gray-500 placeholder-gray-500 transition-all focus:border-[#f7ab0a]/40 focus:text-[#f7ab0a]/40 hover:border-[#f7ab0a]/40' type="text" />
                <input placeholder='Email' className='outline-none bg-slate-400/10 rounded-sm border-b px-6 py-4 border-[#242424] text-gray-500 placeholder-gray-500 transition-all focus:border-[#f7ab0a]/40 focus:text-[#f7ab0a]/40 hover:border-[#f7ab0a]/40' type="text" />
            </div>
